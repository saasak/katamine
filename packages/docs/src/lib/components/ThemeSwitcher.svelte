...
<div class="flex items-center gap-1.5">
	...
	<select
		value={current}
		onchange={select}
		class="rounded-km-field border-km-base-300 bg-km-base-100 text-km-base-content hover:border-km-base-content/30 cursor-pointer border px-2 py-1 text-sm transition-colors focus:outline-none"
	>
