  ...
  <div class="space-y-2">
    ...
    <p class="text-km-muted-content">Ready-to-use, themed SvelteKit components built on Ark UI.</p>
		...
		>
			<HoverCard>
				{#snippet trigger()}
					<span class="text-km-primary cursor-pointer font-medium underline">@katamine</span>
				{/snippet}
				<div class="space-y-2">
					<p class="font-semibold">Katamine UI</p>
    ...
    <div>
      ...
      <p class="text-xs text-km-muted-content">Engineer · Joined Mar 2024</p>
		...
		>
			<HoverCard>
				{#snippet trigger()}
					<span class="text-km-primary cursor-pointer font-medium underline">Jane Doe</span>
				{/snippet}
				<div class="flex items-center gap-3">
					<div
						class="bg-km-primary text-km-primary-content flex h-10 w-10 items-center justify-center rounded-full text-sm font-bold"
					>
						JD
					</div>
					<div>
						<p class="font-semibold">Jane Doe</p>
						<p class="text-km-muted-content text-xs">Engineer · Joined Mar 2024</p>
					</div>
				</div>
			</HoverCard>
		</DemoCard>
		...
		>
			<div class="flex gap-6">
				<HoverCard positioning={{ placement: 'top' }}>
					{#snippet trigger()}
						<span
							class="rounded-km-field border-km-base-300 cursor-pointer border px-3 py-1.5 text-sm"
							>Top</span
						>
					{/snippet}
  ...
  <p>This card has no arrow.</p>
		...
		>
			<HoverCard arrow={false}>
				{#snippet trigger()}
					<span class="text-km-primary cursor-pointer font-medium underline">No arrow</span>
				{/snippet}
  ...
  <p>Opens immediately on hover.</p>
		...
		>
			<HoverCard openDelay={0}>
				{#snippet trigger()}
					<span class="text-km-primary cursor-pointer font-medium underline">Instant hover</span>
				{/snippet}
