...
/>`}
		>
			<div class="space-y-2">
				...
				/>
				{#if rejectedInfo}
					<p class="text-km-error text-sm">
						Rejected: <code class="bg-km-base-200 rounded px-1.5 py-0.5 font-mono text-xs"
							>{rejectedInfo}</code
						>
					</p>
				{/if}
		...
		>
			<div class="space-y-2">
				...
				<p class="text-km-muted-content text-sm">
					<code class="bg-km-base-200 rounded px-1.5 py-0.5 font-mono text-xs"
