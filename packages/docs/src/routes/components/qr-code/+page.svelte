  ...
  {/snippet}
		...
		>
			<QrCode value="https://katamine.dev" encoding={{ ecc: 'H' }}>
				{#snippet overlay()}
					<span class="text-km-primary text-xl font-bold">K</span>
				{/snippet}
			</QrCode>
		</DemoCard>
		...
		>
			<div class="flex flex-col gap-4">
				<input
					...
					class="rounded-km-field border-km-base-300 bg-km-base-100 text-km-base-content focus:border-km-primary border px-3 py-2 text-sm outline-none"
