<script lang="ts">
  ...
  const propsData = [
    { name: "value", type: "string", default: "—", description: "Controlled input value. Supports bind:value" },
    { name: "visible", type: "boolean", default: "—", description: "Controlled visibility state. Supports bind:visible" },
    { name: "defaultVisible", type: "boolean", default: "false", description: "Initial visibility for uncontrolled mode" },
    ...
    { name: "invalid", type: "boolean", default: "false", description: "Mark the input as invalid" },
    { name: "required", type: "boolean", default: "false", description: "Mark the input as required" },
    { name: "onVisibilityChange", type: "(details: { visible: boolean }) => void", default: "—", description: "Callback when visibility state changes" },
...
<div class="space-y-8">
  ...
  <div>
    ...
    <p class="mt-2 text-km-muted-content">
      A password field with a show/hide toggle. Built on Ark UI.
    </p>
  </div>
