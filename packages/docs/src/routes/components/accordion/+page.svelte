<script lang="ts">
	...
	const faqContent: Record<string, string> = {
		...
		install:
			'Run npx katamine init to scaffold your project, then npx katamine add <component> to add individual components.',
		theme:
			'Yes! Katamine uses semantic CSS variables (OKLCH) that you can override. Switch themes via the data-theme attribute on your HTML element.',
		components:
			'Katamine includes Accordion, Collapsible, ComboBox, and more. Each component is fully composed and ready to use out of the box.'
	};
		...
		>
			<div class="max-w-lg space-y-3">
				...
				<p class="text-km-muted-content text-sm">
					Open: <code class="bg-km-base-200 rounded px-1.5 py-0.5 font-mono text-xs"
