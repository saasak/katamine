<script lang="ts">
	...
	const propsData = [
		...
		{
			name: 'getPageUrl',
			type: '(details: { page: number }) => string',
			default: '—',
...
<div class="space-y-8">
	<div>
		...
		<p class="text-km-muted-content mt-2">
			Navigate between pages of content. Supports controlled and uncontrolled modes, configurable
			siblings, and link-based navigation. Built on Ark UI.
		</p>
	</div>
