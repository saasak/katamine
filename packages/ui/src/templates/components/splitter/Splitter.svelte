...
<Splitter.Root
	...
	{onResize}
	{onResizeEnd}
	class="flex h-full w-full {isVertical
		? 'flex-col'
	...
	{#each panels as panelConfig, i}
		...
		{#if i < panels.length - 1}
			<Splitter.ResizeTrigger
				...
				class="bg-km-base-200 hover:bg-km-base-300 focus-visible:outline-km-primary flex shrink-0 items-center justify-center border-none transition-colors duration-150 focus-visible:outline-2 {isVertical
