<script lang="ts">
  ...
  const parsedDefault = $derived(parseColor(value ?? defaultValue));
</script>
  ...
  {#if !inline}
    <ColorPicker.Control class="flex items-center gap-2">
      <ColorPicker.ChannelInput
        channel="hex"
        class="flex-1 border border-km-base-300 rounded-km-field bg-km-base-100 px-3 py-2 text-sm text-km-base-content transition-colors duration-150 focus:border-km-primary focus:outline-2 focus:outline-km-primary focus:-outline-offset-1 placeholder:text-km-muted-content"
      />
    ...
    <div class="rounded-km-box border border-km-base-300 bg-km-base-100 p-3 shadow-km-md space-y-3">
      ...
      <div class="flex items-center gap-2">
        ...
        <div class="flex flex-1 items-center gap-1">
          <ColorPicker.ChannelInput channel="hex" class="flex-1 min-w-0 border border-km-base-300 rounded-km-field bg-km-base-100 px-2 py-1.5 text-xs text-km-base-content text-center transition-colors duration-150 focus:border-km-primary focus:outline-2 focus:outline-km-primary focus:-outline-offset-1" />
          <ColorPicker.ChannelInput channel="alpha" class="w-16 border border-km-base-300 rounded-km-field bg-km-base-100 px-2 py-1.5 text-xs text-km-base-content text-center transition-colors duration-150 focus:border-km-primary focus:outline-2 focus:outline-km-primary focus:-outline-offset-1" />
        </div>
      </div>
