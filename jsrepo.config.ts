	...
	registry: {
		...
		items: [
			...
			},
			{
				name: 'color-picker',
				type: 'component',
				files: [{ path: 'packages/ui/src/templates/components/color-picker' }]
			},
			{
				name: 'combobox',
				type: 'component',
			...
			},
			{
				name: 'floating-panel',
				type: 'component',
				files: [{ path: 'packages/ui/src/templates/components/floating-panel' }]
			},
			{
				name: 'hover-card',
				type: 'component',
			...
			},
			{
				name: 'image-cropper',
				type: 'component',
				files: [{ path: 'packages/ui/src/templates/components/image-cropper' }]
			},
			{
				name: 'marquee',
				type: 'component',
			...
			},
			{
				name: 'signature-pad',
				type: 'component',
				files: [{ path: 'packages/ui/src/templates/components/signature-pad' }]
			},
			{
				name: 'slider',
				type: 'component',
			...
			},
			{
				name: 'tour',
				type: 'component',
				files: [{ path: 'packages/ui/src/templates/components/tour' }]
			},
			{
				name: 'tree-view',
				type: 'component',
